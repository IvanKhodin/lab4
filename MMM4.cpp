...
int main() {
    ...
    cout << "Вариант 9, выполнил Ходин Иван (427 группа) " << endl << endl << endl;
    ...
    cout << "Приведенная к верхне-треугольному виду матрица: " << endl << endl;
    ...
    cout << "Вычисленные методом Гаусса значения: " << endl << endl;
    ...
    cout << "Проверка для метода Гаусса: " << endl << endl;
    ...
    cout << "Норма вектора неувязки для метода Гаусса = " << to_string(r1) << endl << endl;
                                                                                                                      // ПВР
    double V = X[0];
    ...
    cout << "Введите параметр w  для метода ПВР (рекомендуемое = 0.92) " << endl << endl;
    ...
    l(); 
        ...
        cout << "Значения, вычисленные методом ПВР: " << endl << endl;
        ...
        cout << "Проверка для метода ПВР: " << endl << endl;
        ...
        cout << "Норма вектора неувязки для метода ПВР = " << to_string(r2) << endl << endl;
    ...
    */
    ...
    cout << "Нормы 1: Нормы 2:" << endl << endl;
    ...
    cout << "Число обусловленности системы (по строчкам) = " << max1 * max2 << endl;
